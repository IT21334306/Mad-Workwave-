...
import com.example.firebase.adapters.EmpAdapter
                ...
                if (snapshot.exists()) {
                    ...
                    mAdapter.setOnClickListener(object : EmpAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            intent.putExtra("empCity", empList[position].empCity)
                            intent.putExtra("empCharges", empList[position].empCharges)
                            intent.putExtra("empDesc", empList[position].empDesc)
